...
<?php do_action('ampforwp_before_social_icons_hook',$this); ?>
	<div class="amp-wp-content post-pagination-meta ampforwp-social-icons-wrapper ampforwp-social-icons">
		...
		<?php if($redux_builder_amp['enable-single-whatsapp-share'] == true)  { ?>
			<a title="whatsapp share" href="whatsapp://send?text=<?php echo get_the_permalink();?>">
		...
		<?php if($redux_builder_amp['enable-single-line-share'] == true)  { ?>
			<a title="line share" href="http://line.me/R/msg/text/?<?php echo get_the_permalink(); ?>">
		...
		<?php if($redux_builder_amp['enable-single-vk-share'] == true)  { ?>
			<a title="vkontakte share" href="http://vk.com/share.php?url=<?php echo get_the_permalink(); ?>">
		...
		<?php if($redux_builder_amp['enable-single-odnoklassniki-share'] == true)  { ?>
			<a title="odnoklassniki share" href="https://ok.ru/dk?st.cmd=addShare&st._surl=<?php echo get_the_permalink(); ?>" target="_blank">
		...
		<?php if ( true == $redux_builder_amp['enable-single-reddit-share'] ) { ?>
			<a title="reddit share" href="https://reddit.com/submit?url=<?php echo esc_url(get_the_permalink()); ?>&title=<?php echo esc_attr(htmlspecialchars( get_the_title() )); ?>" target="_blank">
		...
		<?php if ( true == $redux_builder_amp['enable-single-tumblr-share'] ) { ?>
			<a title="tumblr share" href="https://www.tumblr.com/widgets/share/tool?canonicalUrl=<?php echo esc_url(get_the_permalink()); ?>&title=<?php echo esc_attr(htmlspecialchars( get_the_title() )); ?>&caption=<?php echo esc_attr(get_the_excerpt()); ?>" target="_blank">
		...
		<?php if ( true == $redux_builder_amp['enable-single-telegram-share'] ) { ?>
			<a title="telegram share" href="https://telegram.me/share/url?url=<?php echo esc_url(get_the_permalink()); ?>&text=<?php echo esc_attr(htmlspecialchars( get_the_title() )); ?>" target="_blank">
		...
		<?php if ( true == $redux_builder_amp['enable-single-digg-share'] ) { ?>
			<a title="digg share" href="http://digg.com/submit?url=<?php echo esc_url(get_the_permalink()); ?>&title=<?php echo esc_attr(htmlspecialchars( get_the_title() )); ?>" target="_blank">
		...
		<?php if ( true == $redux_builder_amp['enable-single-stumbleupon-share'] ) { ?>
			<a title="stumbleupon share" href="http://www.stumbleupon.com/submit?url=<?php echo esc_url(get_the_permalink()); ?>&title=<?php echo esc_attr(htmlspecialchars( get_the_title() )); ?>" target="_blank">
		...
		<?php if ( true == $redux_builder_amp['enable-single-wechat-share'] ) { ?>
			<a title="wechat share" href="http://api.addthis.com/oexchange/0.8/forward/wechat/offer?url=<?php echo esc_url(get_the_permalink()); ?>" target="_blank">
		...
		<?php if ( true == $redux_builder_amp['enable-single-viber-share'] ) { ?>
			<a title="viber share" href="viber://forward?text=<?php echo esc_url(get_the_permalink()); ?>" target="_blank">
		...
		<?php if ( true == $redux_builder_amp['enable-single-hatena-bookmarks'] ) { ?>
			<a title="hatena share" href="http://b.hatena.ne.jp/entry/<?php echo esc_url(get_the_permalink()); ?>" target="_blank">
		...
		<?php if ( true == $redux_builder_amp['enable-single-pocket-share'] ) { ?>
			<a title="pocket share" href="https://getpocket.com/save?url=<?php echo esc_url(get_the_permalink()); ?>" target="_blank">
